HLS_TRANSCODE_FILELIST_OUTPUT_NAME = "hls_transcode.filelist.output.json"

HLS_TRANSCODE_JOURNAL_COMPLETED_OUTPUT_NAME = (
    "hls_transcode.journal.completed.output.json"
)

HLS_TRANSCODE_JOURNAL_FAILED_OUTPUT_NAME = "hls_transcode.journal.failed.output.json"
