from InfoProviders.BasicInfoProvider.Model.BasicInfoModel import BasicTrack, BasicAlbum, BasicCircle
from InfoProviders.ThcInfoProvider.ThcSongInfoProvider.Model.ThcSongInfoModel import Album
import unicodedata
import json
...
def load_circles() -> set:
    ...
    for circle in BasicCircle.select():        
        ...
        alias_norm = [remove_non_content_letters(alias).lower() for alias in json.loads(circle.alias)]
